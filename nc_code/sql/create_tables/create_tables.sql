...
CREATE TABLE datamart.inpStays
(
CNDSID VARCHAR(10) NOT NULL,
STAYID VARCHAR(100) NOT NULL,
ADMITDATE DATE NOT NULL,
DISCHDATE DATE NULL,
DISCHDEST VARCHAR(50) NULL,
FACTYPE VARCHAR(10) NULL,
PROVCODE CHAR(1) NULL,
PROVNAME VARCHAR(100) NULL,
DIAG VARCHAR(10) NULL,
SERVCODE VARCHAR(20) NULL,
LOS INT NULL,
READMIT365IND INT NULL,
EXTRACTDATE DATE NOT NULL,
PRIMARY KEY (CNDSID, STAYID, ADMITDATE)
);