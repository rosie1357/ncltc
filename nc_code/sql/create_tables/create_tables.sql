...
CNDSID VARCHAR(10) NOT NULL,
MBRID CHAR(7) NULL,
MBRID_ONE CHAR(7) NULL,
ALTMBRIDX CHAR(10) NULL,
ID_TYPE CHAR(1) NULL,
TCN CHAR(16) NOT NULL PRIMARY KEY,
CLMDATE_ONE DATE  NULL,
SVCBGN DATE NULL,
SVCEND DATE NULL,
PYRID TINYINT(1) NULL,
ADCOUNTYCODE CHAR(3) NULL,
RESCNTYCODE CHAR(3) NULL,
LNESTSCODE CHAR(1) NULL,
CLMHDRPDDATE DATE NULL,
DMHBNUM CHAR(10) NULL,
PAYCARRID CHAR(10) NULL,
LMEMCO VARCHAR(100) NULL,
LNERMBAMT INT NULL,
LNESSBMAMT FLOAT(10,2) NULL,
CLMLNENETAMT FLOAT(10,2) NULL,
PAYPDAMT FLOAT(10,2) NULL,
AMTPD FLOAT(10,2) NULL,
PROCCODE VARCHAR(20) NULL,
SERVCODE VARCHAR(20) NULL,
PROCLGDES VARCHAR(100) NULL,
PROCSTDES VARCHAR(50) NULL
);